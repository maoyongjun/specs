...
- `fc/Gemini-Api/src/main/java/com/drh/gemini/api/PianoNoteSequenceTemplateMatcher.java`：D1/D2/D3 音序模板匹配器，输出模板分数、高置信工程判定，处理 D2 结尾连续 E 音级优先规则；D014 新增 `contiguousPhraseSimilarity` 与 D1 窄口径纠偏/移调评分。
